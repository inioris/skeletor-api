...
export const buildError = (code: number, info: string | string[] | undefined) => {
  const message: string = httpMessages[code]
    ? httpMessages[code] : httpMessages[httpCodes.SERVER_ERROR];
  return {
    code,
    message,
    info,
